 ...
 */
public class Dm3RatlyMetricRegistryImpl implements RatlyMetricRegistry {
  static Dm3RatlyMetricRegistryImpl cast(RatlyMetricRegistry registry) {
    if (!(registry instanceof Dm3RatlyMetricRegistryImpl)) {
      throw new IllegalStateException("Unexpected class: " + registry.getClass().getName());
    }
    return (Dm3RatlyMetricRegistryImpl) registry;
  }
  ...
  public Dm3RatlyMetricRegistryImpl(MetricRegistryInfo info) {
