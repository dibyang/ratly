...
import net.xdob.ratly.examples.filestore.FileInfo.ReadOnly;
import net.xdob.ratly.examples.filestore.FileInfo.UnderConstruction;
import net.xdob.ratly.proto.ExamplesProtos.ReadReplyProto;
import net.xdob.ratly.proto.ExamplesProtos.StreamWriteReplyProto;
import net.xdob.ratly.proto.ExamplesProtos.WriteReplyProto;
