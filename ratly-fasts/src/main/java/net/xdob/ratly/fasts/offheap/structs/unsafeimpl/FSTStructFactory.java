 ...
 */
package net.xdob.ratly.fasts.offheap.structs.unsafeimpl;

import net.xdob.ratly.fasts.offheap.bytez.Bytez;
import net.xdob.ratly.fasts.offheap.bytez.BytezAllocator;
import net.xdob.ratly.fasts.offheap.bytez.onheap.HeapBytezAllocator;
import net.xdob.ratly.fasts.offheap.structs.*;
import net.xdob.ratly.fasts.offheap.structs.structtypes.StructArray;
import net.xdob.ratly.fasts.offheap.structs.structtypes.StructByteString;
import net.xdob.ratly.fasts.offheap.structs.structtypes.StructString;
            ...
            if ( allowed ) {
                ...
                } else if ( methName.endsWith("Len") && lenfi != null )
                {
                    ...
                    if ( methName.equals("getFieldValues") &&
                            ( (clInfo.getClazz().getSuperclass().getName().equals("net.xdob.ratly.fasts.reallive.impl.RLStructRow")) // oops
