...
package net.xdob.ratly.fasts.offheap.structs.structtypes;

import net.xdob.ratly.fasts.offheap.bytez.Bytez;
import net.xdob.ratly.fasts.offheap.structs.FSTStruct;
import net.xdob.ratly.fasts.offheap.structs.NoAssist;
import net.xdob.ratly.fasts.offheap.structs.Templated;
