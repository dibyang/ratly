...
package net.xdob.ratly.security.crypto.password;



import net.xdob.ratly.security.crypto.codec.Hex;
import net.xdob.ratly.security.crypto.codec.Utf8;
import net.xdob.ratly.security.crypto.keygen.BytesKeyGenerator;
import net.xdob.ratly.security.crypto.keygen.KeyGenerators;
import net.xdob.ratly.security.crypto.util.EncodingUtils;
 ...
 * {@link net.xdob.ratly.security.crypto.bcrypt.BCryptPasswordEncoder} is a better
